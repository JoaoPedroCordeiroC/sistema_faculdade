...
class AvaliacaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create avaliacao" do
    assert_difference('Avaliacao.count') do
      post avaliacaos_url, params: { avaliacao: { nota: @avaliacao.nota, prova_id: @avaliacao.prova_id, trabalho_id: @avaliacao.trabalho_id } }
    end
  ...
  test "should update avaliacao" do
    patch avaliacao_url(@avaliacao), params: { avaliacao: { nota: @avaliacao.nota, prova_id: @avaliacao.prova_id, trabalho_id: @avaliacao.trabalho_id } }
