...
class TrabalhosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trabalho" do
    assert_difference('Trabalho.count') do
      post trabalhos_url, params: { trabalho: { descricao: @trabalho.descricao, nota: @trabalho.nota } }
    end
  ...
  test "should update trabalho" do
    patch trabalho_url(@trabalho), params: { trabalho: { descricao: @trabalho.descricao, nota: @trabalho.nota } }
