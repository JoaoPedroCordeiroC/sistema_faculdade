...
class SemestresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create semestre" do
    assert_difference('Semestre.count') do
      post semestres_url, params: { semestre: { ano_id: @semestre.ano_id, nome: @semestre.nome } }
    end
  ...
  test "should update semestre" do
    patch semestre_url(@semestre), params: { semestre: { ano_id: @semestre.ano_id, nome: @semestre.nome } }
