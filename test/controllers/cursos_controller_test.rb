...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post cursos_url, params: { curso: { carga_horaria: @curso.carga_horaria, nome: @curso.nome, semestre_id: @curso.semestre_id } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { carga_horaria: @curso.carga_horaria, nome: @curso.nome, semestre_id: @curso.semestre_id } }
